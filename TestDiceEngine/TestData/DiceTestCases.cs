...
public static partial class TestCases
{
    ...
    [
        ...
        new TestCase("1d1", new DiceSet(1, (Die)1), new RandomCollection(1, 1, 1, 1,
            collectionValidator: x => CompareDieToResult(new DiceSet(1, (Die)1), x))),
        new TestCase("2d2", new DiceSet(2, (Die)2), new RandomCollection(2, 2, 1, 2,
            collectionValidator: x => CompareDieToResult(new DiceSet(2, (Die)2), x))),
        new TestCase("3d4", new DiceSet(3, (Die)4), new RandomCollection(3, 3, 1, 4,
            collectionValidator: x => CompareDieToResult(new DiceSet(3, (Die)4), x))),
        new TestCase("4d6", new DiceSet(4, (Die)6), new RandomCollection(4, 4, 1, 6,
            collectionValidator: x => CompareDieToResult(new DiceSet(4, (Die)6), x))),
        new TestCase("5d8", new DiceSet(5, (Die)8), new RandomCollection(5, 5, 1, 8,
            collectionValidator: x => CompareDieToResult(new DiceSet(5, (Die)8), x))),
        new TestCase("6d10", new DiceSet(6, (Die)10), new RandomCollection(6, 6, 1, 10,
            collectionValidator: x => CompareDieToResult(new DiceSet(6, (Die)10), x))),
        new TestCase("7d12", new DiceSet(7, (Die)12), new RandomCollection(7, 7, 1, 12,
            collectionValidator: x => CompareDieToResult(new DiceSet(7, (Die)12), x))),
        new TestCase("8d20", new DiceSet(8, (Die)20), new RandomCollection(8, 8, 1, 20,
            collectionValidator: x => CompareDieToResult(new DiceSet(8, (Die)20), x))),
        new TestCase("9d100", new DiceSet(9, (Die)100), new RandomCollection(9, 9, 1, 100,
            collectionValidator: x => CompareDieToResult(new DiceSet(9, (Die)100), x))),
        new TestCase("45d%", new DiceSet(45, new PercentileDie()), new RandomCollection(45, 45, 0, 90,
            x => x is Number num && num.Value % 10 == 0,
            x => CompareDieToResult(new DiceSet(45, new PercentileDie()), x))),
        new TestCase("33dF", new DiceSet(33, new FateDie()), new RandomCollection(33, 33, -1, 1,
            collectionValidator: x => CompareDieToResult(new DiceSet(33, new FateDie()), x))),
    ];
