...
public static partial class TestCases
{
    ...
    [
        ...
        new TestCase(" 1+2-3*4  /5^7&&8||9⊕10==11", new BinaryOperator("||", new BinaryOperator("&&",
            ...
            new BinaryOperator("||", new Number(1), Logical.TRUE),
        ...
        new TestCase("true", new Logical(true), new Number(1)),
        new TestCase("false", new Logical(false), new Number(0)),
        ...
        new TestCase("is_num(infinity)", new FunctionCall("is_num", [new Constant("infinity")]), Logical.FALSE),
