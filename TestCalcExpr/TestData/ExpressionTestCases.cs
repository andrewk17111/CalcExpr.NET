...
public static partial class TestCases
{
    ...
    [
        ...
        new TestCase(" 2 <>2", [new NumberToken("2", 1), new OpenBracketToken(Bracket.Angle, 3), new CloseBracketToken(Bracket.Angle, 4),
                new NumberToken("2", 5)],
            new BinaryOperator("<>", new Number(2), new Number(2)), Logical.FALSE),
        new TestCase(" 1 <2", [new NumberToken("1", 1), new OpenBracketToken(Bracket.Angle, 3), new NumberToken("2", 4)],
            new BinaryOperator("<", new Number(1), new Number(2)), Logical.TRUE),
        new TestCase(" 1>2", [new NumberToken("1", 1), new CloseBracketToken(Bracket.Angle, 2), new NumberToken("2", 3)],
            new BinaryOperator(">", new Number(1), new Number(2)), Logical.FALSE),
        new TestCase(" 1 <=2", [new NumberToken("1", 1), new OpenBracketToken(Bracket.Angle, 3), new SymbolToken('=', 4), new NumberToken("2", 5)],
            new BinaryOperator("<=", new Number(1), new Number(2)), Logical.TRUE),
        ...
        new TestCase(" 1 >=2", [new NumberToken("1", 1), new CloseBracketToken(Bracket.Angle, 3), new SymbolToken('=', 4), new NumberToken("2", 5)],
            new BinaryOperator(">=", new Number(1), new Number(2)), Logical.FALSE),
        ...
        new TestCase("dist = ([IsNumber]x, [NotUndefined  ]  y) => (((x - 0)^2)+((y)^2)) ^ (1/2)",
            [new WordToken("dist", 1), new SymbolToken('=', 5), new OpenBracketToken(Bracket.Parenthesis, 7),
                new OpenBracketToken(Bracket.Square, 8), new WordToken("IsNumber", 9), new CloseBracketToken(Bracket.Square, 16),
                new WordToken("x", 17), new SymbolToken(',', 18), new OpenBracketToken(Bracket.Square, 20), new WordToken("NotUndefined", 21),
                new CloseBracketToken(Bracket.Square, 35), new WordToken("y", 38), new CloseBracketToken(Bracket.Parenthesis, 39),
                new SymbolToken('=', 41), new CloseBracketToken(Bracket.Angle, 42), new OpenBracketToken(Bracket.Parenthesis, 44),
                new OpenBracketToken(Bracket.Parenthesis, 45), new OpenBracketToken(Bracket.Parenthesis, 46), new WordToken("x", 47),
                new SymbolToken('-', 49), new NumberToken("0", 51), new CloseBracketToken(Bracket.Parenthesis, 52), new SymbolToken('^', 53),
                new NumberToken("2", 54), new CloseBracketToken(Bracket.Parenthesis, 55), new SymbolToken('+', 56),
                new OpenBracketToken(Bracket.Parenthesis, 57), new OpenBracketToken(Bracket.Parenthesis, 58), new WordToken("y", 59),
                new CloseBracketToken(Bracket.Parenthesis, 60), new SymbolToken('^', 61), new NumberToken("2", 62),
                new CloseBracketToken(Bracket.Parenthesis, 63), new CloseBracketToken(Bracket.Parenthesis, 64), new SymbolToken('^', 66),
                new OpenBracketToken(Bracket.Parenthesis, 68), new NumberToken("1", 69), new SymbolToken('/', 70), new NumberToken("2", 71),
                new CloseBracketToken(Bracket.Parenthesis, 72)],
        ...
        new TestCase("get_pi = () => pi",
            [new WordToken("get_pi", 0), new SymbolToken('=', 7), new OpenBracketToken(Bracket.Parenthesis, 9),
                new CloseBracketToken(Bracket.Parenthesis, 10), new SymbolToken('=', 12), new CloseBracketToken(Bracket.Angle, 13),
                new WordToken("pi", 15)],
        ...
        new TestCase("trig = [IsNumber, Minimum(0)] n => triangle(n)",
            [new WordToken("trig", 0), new SymbolToken('=', 5), new OpenBracketToken(Bracket.Square, 7), new WordToken("IsNumber", 8),
                ...
                new SymbolToken('=', 32), new CloseBracketToken(Bracket.Angle, 33), new WordToken("triangle", 35),
