...
public static partial class TestCases
{
    ...
    [
        ...
        new TestCase(" ~2", new UnaryOperator("~", true, new Number(2)), Constant.FALSE),
        new TestCase(" ¬0", new UnaryOperator("¬", true, new Number(0)), Constant.TRUE),
        ...
        new TestCase("~!1 ", new UnaryOperator("~", true, new UnaryOperator("!", true, new Number(1))), Constant.TRUE,
        ...
        new TestCase("-13%(-13)", new BinaryOperator("%", new UnaryOperator("-", true, new Number(13)),
                new Parentheses(new UnaryOperator("-", true, new Number(13)))), new Number(0),
            new BinaryOperator("%", new Number(-13), new Parentheses(new UnaryOperator("-", true, new Number(13)))),
            new BinaryOperator("%", new Number(-13), new Parentheses(new Number(-13))),
            new BinaryOperator("%", new Number(-13), new Number(-13))),
        new TestCase("-12.6%(-13)", new BinaryOperator("%", new UnaryOperator("-", true, new Number(12.6)),
                new Parentheses(new UnaryOperator("-", true, new Number(13)))), new Number(0.4),
            new BinaryOperator("%", new Number(-12.6), new Parentheses(new UnaryOperator("-", true, new Number(13)))),
        ...
        new TestCase("-12.6//-13.5", new BinaryOperator("//", new UnaryOperator("-", true, new Number(12.6)),
            ...
            new BinaryOperator("//", new Number(-12.6), new Number(-13.5))),
        new TestCase(" 1&&2", new BinaryOperator("&&", new Number(1), new Number(2)), Constant.TRUE),
        new TestCase(" 1&&0", new BinaryOperator("&&", new Number(1), new Number(0)), Constant.FALSE),
        new TestCase(" 0∧1", new BinaryOperator("∧", new Number(0), new Number(1)), Constant.FALSE),
        new TestCase(" 0∧0", new BinaryOperator("∧", new Number(0), new Number(0)), Constant.FALSE),
        new TestCase(" 1||2", new BinaryOperator("||", new Number(1), new Number(2)), Constant.TRUE),
        new TestCase(" 0||2", new BinaryOperator("||", new Number(0), new Number(2)), Constant.TRUE),
        new TestCase(" 1 ∨0", new BinaryOperator("∨", new Number(1), new Number(0)), Constant.TRUE),
        new TestCase(" 0 ∨0", new BinaryOperator("∨", new Number(0), new Number(0)), Constant.FALSE),
        new TestCase(" 1 ⊕5", new BinaryOperator("⊕", new Number(1), new Number(5)), Constant.FALSE),
        new TestCase(" 4 ⊕0", new BinaryOperator("⊕", new Number(4), new Number(0)), Constant.TRUE),
        new TestCase(" 0 ⊕2", new BinaryOperator("⊕", new Number(0), new Number(2)), Constant.TRUE),
        new TestCase(" 0 ⊕0", new BinaryOperator("⊕", new Number(0), new Number(0)), Constant.FALSE),
        ...
        new TestCase(" 1+2-3*4  /5^7&&8||9⊕10==11", new BinaryOperator("||", new BinaryOperator("&&",
            ...
            Constant.TRUE, new BinaryOperator("||", new BinaryOperator("&&", new BinaryOperator("-", new Number(3),
            ...
            new BinaryOperator("||", new BinaryOperator("&&", new Number(3 - ((double)12 / 78125)), new Number(8)),
                new BinaryOperator("⊕", new Number(9), new BinaryOperator("==", new Number(10), new Number(11)))),
            new BinaryOperator("||", Constant.TRUE, new BinaryOperator("⊕", new Number(9), new BinaryOperator("==",
                new Number(10), new Number(11)))),
            ...
            new BinaryOperator("||", new Number(1), Constant.TRUE),
        ...
        new TestCase("!¬2*-  +3", new BinaryOperator("*", new UnaryOperator("!", true, new UnaryOperator("¬", true,
            ...
            new Number(-3), new BinaryOperator("*", new UnaryOperator("!", true, Constant.FALSE),
                new UnaryOperator("-", true, new UnaryOperator("+", true, new Number(3)))),
            new BinaryOperator("*", new UnaryOperator("!", true, new Number(0)), new UnaryOperator("-", true,
                new UnaryOperator("+", true, new Number(3)))),
        ...
        new TestCase("1+((2-τ)*(4 /-pi))^7&& abc_1||9⊕10==  11", new BinaryOperator("||", new BinaryOperator("&&",
            new BinaryOperator("+", new Number(1), new BinaryOperator("^", new Parentheses(new BinaryOperator("*",
                ...
                new Number(7))), new Variable("abc_1")), new BinaryOperator("⊕", new Number(9),
                    new BinaryOperator("==", new Number(10), new Number(11)))),
            Constant.TRUE, new BinaryOperator("||", new BinaryOperator("&&", new BinaryOperator("+", new Number(1),
            ...
            new BinaryOperator("||", new BinaryOperator("&&", new BinaryOperator("+", new Number(1),
                    new BinaryOperator("^", new Parentheses(new BinaryOperator("*", new Parentheses(
                        new Number(2 - Math.Tau)), new Parentheses(new BinaryOperator("/", new Number(4),
                            new UnaryOperator("-", true, new Constant("pi")))))), new Number(7))),
                    new Variable("abc_1")),
                new BinaryOperator("⊕", new Number(9), new BinaryOperator("==", new Number(10), new Number(11)))),
            new BinaryOperator("||", new BinaryOperator("&&", new BinaryOperator("+", new Number(1),
        ...
        new TestCase("abcd_αβγ_xyz=inf", new AssignmentOperator(new Variable("abcd_αβγ_xyz"), new Constant("inf")),
            new Constant("inf")),
        new TestCase("--1", new UnaryOperator("--", true, new Number(1)), new Number(0)),
        ...
        new TestCase("g(abc_1, 2, 3+4*1)", new FunctionCall("g", [new Variable("abc_1"), new Number(2),
            ...
            new Number(9), new FunctionCall("g", [new Number(1), new Number(2),
                new BinaryOperator("+", new Number(3), new BinaryOperator("*", new Number(4), new Number(1)))]),
            new FunctionCall("g", [new Number(1), new Number(2),
        ...
        new TestCase("not(1)", new FunctionCall("not", [new Number(1)]), new Number(0)),
        new TestCase("if(1, 2, 3)", new FunctionCall("if", [new Number(1), new Number(2), new Number(3)]),
            new Number(2)),
        new TestCase("is_na(dne)", new FunctionCall("is_na", [new Constant("dne")]), new Number(1)),
        new TestCase("is_na(1)", new FunctionCall("is_na", [new Number(1)]), new Number(0)),
        new TestCase("is_num(1)", new FunctionCall("is_num", [new Number(1)]), new Number(1)),
        new TestCase("is_num(abcd)", new FunctionCall("is_num", [new Variable("abcd")]), new Number(0)),
    ];
