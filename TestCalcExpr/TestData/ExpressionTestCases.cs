...
public static partial class TestCases
{
    ...
    [
        ...
        new TestCase(" ~2", new PrefixOperator("~", new Number(2)), Constant.FALSE),
        new TestCase(" ¬0", new PrefixOperator("¬", new Number(0)), Constant.TRUE),
        ...
        new TestCase("~!1 ", new PrefixOperator("~", new PrefixOperator("!", new Number(1))), Constant.TRUE,
        ...
        new TestCase("!¬2*-  +3", new BinaryOperator("*", new PrefixOperator("!", new PrefixOperator("¬",
            ...
            new Number(-3), new BinaryOperator("*", new PrefixOperator("!", Constant.FALSE),
                new PrefixOperator("-", new PrefixOperator("+", new Number(3)))),
            new BinaryOperator("*", new PrefixOperator("!", new Number(0)), new PrefixOperator("-",
                new PrefixOperator("+", new Number(3)))),
        ...
        new TestCase("-∞", new PrefixOperator("-", new Constant("∞")), new Constant("-∞")),
        new TestCase("-inf", new PrefixOperator("-", new Constant("inf")), new Constant("-inf")),
        new TestCase("-infinity ", new PrefixOperator("-", new Constant("infinity")), new Constant("-infinity")),
        ...
        new TestCase("undefined", new Undefined("undefined")),
        new TestCase("dne", new Undefined("dne")),
        ...
        new TestCase("3-infinity", new BinaryOperator("-", (Number)3, Constant.INFINITY), Constant.NEGATIVE_INFINITY),
    ];
